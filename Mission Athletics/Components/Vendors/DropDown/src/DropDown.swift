...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var cornrRadius = DPDConstant.UI.CornerRadius {
		willSet {
	...
	*/
	@objc public dynamic var shadwColor = DPDConstant.UI.Shadow.Color {
	...
	Changing the shadow color automatically reloads the drop down.
	*/
	@objc public dynamic var shadwOffset = DPDConstant.UI.Shadow.Offset {
	...
	*/
	@objc public dynamic var shadwOpacity = DPDConstant.UI.Shadow.Opacity {
	...
	*/
	@objc public dynamic var shadwRadius = DPDConstant.UI.Shadow.Radius {
